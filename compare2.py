...
results_dir = os.path.expanduser("~/Documents/CognativeRobotics&ComputerVision/ComputerVision/results_big_dataset")
graphs_dir = os.path.join(cv_dir, "graphs_big_dataset")
